...
export async function createBooking(bookingData) {
  try {
    ...
    const formattedStartTime = format(new Date(bookingData.startTime), "EEEE, MMMM d, yyyy 'at' h:mm a");
    const formattedEndTime = format(new Date(bookingData.endTime), "h:mm a");
    ...
    await sendEmail({
      to: event.user.email,
      template: "bookingNotificationToHost",
      data: {
        guestName: bookingData.name,
